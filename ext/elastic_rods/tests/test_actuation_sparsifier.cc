...
int main(int argc, const char *argv[]) {
    ...
    auto closest_pts_sensitivity = sparsifier.target_surface_fitter.linkage_closest_surf_pt_sensitivities;
    ...
    auto closest_pts_plus = sparsifier.target_surface_fitter.linkage_closest_surf_pts;
    auto closest_tris_plus = sparsifier.target_surface_fitter.linkage_closest_surf_tris;
    ...
    auto closest_pts_minus = sparsifier.target_surface_fitter.linkage_closest_surf_pts;
    auto closest_tris_minus = sparsifier.target_surface_fitter.linkage_closest_surf_tris;
