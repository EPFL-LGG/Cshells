...
struct Rectangle : public ::ParametricCrossSection {
    using ParametricCrossSection::ParametricCrossSection;
    ...
    virtual std::unique_ptr<CrossSection> copy() const override {
